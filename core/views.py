...
class QuestionCreateView(CreateView):
  ...
  def form_valid(self, form):
      form.nstance.user = self.request.user
...
class AnswerCreateView(CreateView):
    model = Answer
    template_name = "amswer/answer_form.html"
    fields = ['text']
    ...
    def from_valid(self, form):
        ...
        form.instance.question = Question.objects.get(id=self.kwargs['pl'])
...
class AnswerDeleteView(DeleteView):
    model = Answer
    pk_url_kwarg = 'answer_pk'
    template_name = 'answe/answer_confirm_delete.html'
